...
if(WITH_FFMPEG)
  ...
  elseif(PKG_CONFIG_FOUND)
    ...
    if(ANDROID)
      ocv_check_modules_android(libavcodec)
      ocv_check_modules_android(libavformat)
      ocv_check_modules_android(libavutil)
      ocv_check_modules_android(libswscale)
      ocv_check_modules_android(libavresample)
      set(FFMPEG_INCLUDE_DIR "${FFMPEG_ROOT}/include")
      set(FFMPEG_LIB_DIR "${FFMPEG_ROOT}/lib")
      set(VIDEOIO_LIBRARIES ${VIDEOIO_LIBRARIES} "${FFMPEG_LIB_DIR}/libavformat-${FFMPEG_VERSION}.a" 
          "${FFMPEG_LIB_DIR}/libavcodec-${FFMPEG_VERSION}.a" "${FFMPEG_LIB_DIR}/libavutil-${FFMPEG_VERSION}.a"
          "${FFMPEG_LIB_DIR}/libswscale-${FFMPEG_VERSION}.a" "${FFMPEG_LIB_DIR}/libavresample-${FFMPEG_VERSION}.a")
